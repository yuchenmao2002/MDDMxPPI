#!/usr/bin/env python3
"""Add HGNC previous, alias, and Ensembl IDs to STRING-missing HGNC rows."""
...
DEFAULT_INPUT = INTERIM_STRING_DIR / "hgnc_missing.csv"
DEFAULT_OUTPUT = INTERIM_STRING_DIR / "hgnc_missing_with_info.csv"
...
def fetch_hgnc_symbols_batch(
    ...
    request = Request(
        ...
        headers={
            ...
            "User-Agent": "CodeNo0-hgnc-string-missing-annotation/1.0",
        },
    )
